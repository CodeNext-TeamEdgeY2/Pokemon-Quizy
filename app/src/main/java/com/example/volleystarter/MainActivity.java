...
public class MainActivity extends AppCompatActivity {
    ...
    public void playGame(View view){
        ...
        if (answer == 1){
            fetchData(null);
            flag1 = 1;
            pokeimg1.setVisibility(View.VISIBLE);
            pokeimg2.setVisibility(View.INVISIBLE);
            pokeimg3.setVisibility(View.INVISIBLE);
            pokeimg4.setVisibility(View.INVISIBLE);

        }else if (answer == 2) {
            fetchData(null);
            flag2 = 1;
            pokeimg2.setVisibility(View.VISIBLE);
            pokeimg1.setVisibility(View.INVISIBLE);
            pokeimg3.setVisibility(View.INVISIBLE);
            pokeimg4.setVisibility(View.INVISIBLE);
            ...
            fetchData(null);
            flag3 = 1;
            pokeimg3.setVisibility(View.VISIBLE);
            pokeimg2.setVisibility(View.INVISIBLE);
            pokeimg1.setVisibility(View.INVISIBLE);
            pokeimg4.setVisibility(View.INVISIBLE);
            ...
            fetchData(null);
            flag4 = 1;
            pokeimg4.setVisibility(View.VISIBLE);
            pokeimg2.setVisibility(View.INVISIBLE);
            pokeimg3.setVisibility(View.INVISIBLE);
            pokeimg1.setVisibility(View.INVISIBLE);
